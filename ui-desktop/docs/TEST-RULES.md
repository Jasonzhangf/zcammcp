...
### 已完成功能
- [x] TODO#3: cycle --json 输出格式 (2026-02-24)

- [x] TODO#1: cycle 滚动条规则验证 (2026-02-23)
- [x] TODO#2: 恢复后控件 heartbeat 检查 (2026-02-23)
...
- [x] CLI `ui window` 子命令：shrink/restore/toggle-size/set-bounds/cycle；
