...
export const ShutterModal: React.FC<ShutterModalProps> = ({ open, current, options, title, anchorRef, onClose, onSelect }) => {
  ...
  return (
    <Modal open={open} title={title || 'Shutter Speed'} anchorRef={anchorRef} onClose={onClose}>
